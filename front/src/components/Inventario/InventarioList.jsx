          ...
          <TableHead>
            <TableRow sx={{ minWidth: 800 }} className="py-4 border-bottom-4 border-gray-400 shadow shadow-gray-700 flex flex-row justify-between bg-white">
              <TableCell className="w-auto border-0" align="center">
                <span className="text-md font-roboto text-gray-400">Estado</span>
              </TableCell>
              ...
              <TableCell className="w-auto border-0" align="center">
                <span className="text-md font-roboto text-gray-400">Moneda</span>
              </TableCell>
              ...
              <TableCell className="w-auto border-0" align="center">
                <span className="text-md font-roboto text-gray-400">Acciones</span>
              </TableCell>
            </TableRow>
          </TableHead>
          &nbsp;
