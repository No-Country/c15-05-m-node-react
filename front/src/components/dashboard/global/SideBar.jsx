...
const SidebarMenu = () => {
  ...
  const handleCollapsed = () => {
    if (collapsedBar === false) {
      setCollapsedBar(true);
    }
    if (collapsedBar === true) {
    ...
    >
      ...
      >
        ...
        <MenuItem
          ...
          component={<Link to="/ua/product/catalogo" />}
        >
          <Typography
            sx={{
              color: "grey",
        ...
        <MenuItem
          ...
          component={<Link to="/ua/product/inventory" />}
        >
          <Typography
            sx={{
              color: "grey",
        ...
        <MenuItem
          ...
          component={<Link to="/ua/product/edit" />}
        >
          <Typography
            sx={{
              color: "grey",
        ...
        <MenuItem
          ...
          component={<Link to="/ua/product/create" />}
        >
          <Typography
            sx={{
              color: "grey",
        ...
        <MenuItem
          ...
          component={<Link to="/ua/control-eua" />}
        >
          <Typography
            sx={{
              color: "grey",
